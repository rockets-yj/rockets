...
if(svcList[1] && svcList[1].user_id !== undefined) {
    nameDiv.innerText = "사용자 : " + svcList[1].user_id;
...
if (svcList.length == 0) {
    ...
    for(let i=0; i<svcList.length; i++){
        ...
        tr.append(td1, td2, td4, td5, td6, serviceId);
        tbody.append(tr);
